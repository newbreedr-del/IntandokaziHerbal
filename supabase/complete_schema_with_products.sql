...
(
  ...
  true,
  false,
  'shower-gel-ikhipha-isichitho.jpg'
),
...
(
  ...
  true,
  false,
  'umkhanyakude-jelly-vaseline.jpg'
),
...
(
  ...
  true,
  false,
  'umakhiphi-isichitho-vaseline.jpg'
);
...
BEGIN
  ...
  RAISE NOTICE '5. Test database connection via /api/test-db';
  RAISE NOTICE '============================================================================';
END $$;
