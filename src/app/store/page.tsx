...
export default function StorePage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setShowBookingPopup(true), 15000);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Top info bar */}
      <div className="bg-brand-900 text-brand-300 text-xs py-1.5 px-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-x-6 gap-y-1">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1"><Phone className="w-3 h-3" />{SITE_CONFIG.phoneFormatted}</span>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4 pb-6 sm:pb-0">
          ...
          <div className="relative z-10 w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="relative h-52">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-brand-900/50 via-brand-800/40 to-brand-900/80" />
              {/* Close */}
              <button
                onClick={() => setShowBookingPopup(false)}
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                <div className="inline-flex items-center gap-1.5 bg-white/20 border border-white/30 text-white text-xs px-3 py-1 rounded-full mb-3 backdrop-blur-sm">
                ...
                <p className="text-white/80 text-sm">
                  Personalised herbal remedy advice — nationwide
                </p>
              </div>
            </div>
            ...
            <div className="px-5 py-4">
              <div className="flex flex-col gap-2">
                <button
                  onClick={() => { setShowBookingPopup(false); setShowBookingModal(true); }}
                  className="w-full flex items-center justify-center gap-2 bg-brand-600 hover:bg-brand-500 text-white py-3 rounded-xl font-semibold text-sm transition-all shadow-lg shadow-brand-900/20"
                >
                  <Calendar className="w-4 h-4" />
                  Book Now
                </button>
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setShowBookingPopup(false)}
                  className="w-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-semibold text-sm transition-all shadow-lg shadow-green-900/20"
                >
                  <MessageCircle className="w-4 h-4" />
                  Chat on WhatsApp
                </a>
