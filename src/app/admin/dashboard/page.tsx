...
import { Package, DollarSign, TrendingUp, Truck, Download, Eye, Search } from "lucide-react";
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-brand-600 mt-1">Welcome to your admin panel</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <Button onClick={() => router.push("/admin/products")} icon={<Package className="w-4 h-4" />}>
          Manage Products
        </Button>
        <Button onClick={() => router.push("/store")} variant="secondary" icon={<Package className="w-4 h-4" />}>
          View Store
        </Button>
      </div>
