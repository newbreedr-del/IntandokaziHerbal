...
async function testCorrectSecret() {
  const clientId = 'test-4c7f8693-3514-4953-5d88-d8f90c116731';
  const clientSecret = 'shvBMeqMqSNaAWz/sLL7/Hrx2j2QRHAJYKovyIq27gF3O8cv4/uTCYe1JjQLrnS0';

  console.log('🧪 Testing with CORRECT Client Secret...\n');
  ...
  try {
    ...
    if (response.data.success && response.data.data?.accessToken) {
      ...
      console.log('\n✅✅✅ STITCH INTEGRATION IS NOW FULLY WORKING! ✅✅✅');
      console.log('\n🚀 You can now test payments on your site!');
    }
  } catch (error) {
