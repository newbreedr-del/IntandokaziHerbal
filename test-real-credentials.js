...
async function testRealCredentials() {
  ...
  const clientSecret = 'sfyBVeqMpSNaaWzaLL7xHrg2j2QRsHJYK6wjG27gf3Q8cw4uTCYeHJQLm5Q';

  console.log('🧪 Testing REAL Stitch Express credentials...\n');
  ...
  try {
    ...
    if (response.data.success && response.data.data?.accessToken) {
      ...
      console.log('\n✅ Your Stitch integration is now WORKING!');
      console.log('✅ You can now make test payments!');
